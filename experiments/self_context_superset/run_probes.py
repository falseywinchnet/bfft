...
from experiments.self_context_superset.run_benchmark import train_variant
...
def main():
    parser = argparse.ArgumentParser(); parser.add_argument("--out", type=Path, default=Path("/tmp/self_context_superset_probes.json"))
